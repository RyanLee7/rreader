...
public abstract class Activity extends _HoloActivity {
	...
	private final IAddonBasicAttacher<IAddonActivity, Activity> mAttacher = new IAddonBasicAttacher<IAddonActivity, Activity>(
			this);
	...
	public Bundle instanceState(Bundle savedInstanceState) {
		...
		if (extras != null
				&& extras.containsKey(ThemeManager.KEY_INSTANCE_STATE)) {
	...
	@Override
	public boolean onCreatePanelMenu(final int featureId,
	...
	@Override
	public boolean onMenuOpened(final int featureId,
			final android.view.Menu menu) {
		return performAddonAction(new AddonCallback<IAddonActivity>() {
			@Override
			public boolean action(IAddonActivity addon) {
